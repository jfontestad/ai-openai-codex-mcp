#!/usr/bin/env node
// Test purpose: Send notifications/cancelled immediately after tools/call execution,
// and verify that result/error for that id is not output (suppressed).
// If OPENAI_API_KEY is not set, skip (exit 0).
